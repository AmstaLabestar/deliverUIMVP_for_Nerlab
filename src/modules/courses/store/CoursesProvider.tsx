...
export const CoursesProvider = ({ children }: CoursesProviderProps) => {
  ...
  const hasNextAvailablePage = Boolean(availableCoursesQuery.hasNextPage);
  const hasNextHistoryPage = Boolean(historyQuery.hasNextPage);
  const isFetchingNextAvailablePage = availableCoursesQuery.isFetchingNextPage;
  const isFetchingNextHistoryPage = historyQuery.isFetchingNextPage;
  ...
  return (
    <CoursesDataProvider
      ...
      hasNextAvailablePage={hasNextAvailablePage}
      hasNextHistoryPage={hasNextHistoryPage}
    >
      <CoursesStatusProvider
        ...
        availableCoursesIsFetchingNextPage={isFetchingNextAvailablePage}
        historyIsPending={historyQuery.isPending}
        historyError={historyQuery.error}
        historyIsFetchingNextPage={isFetchingNextHistoryPage}
      >
        <CoursesActionsProvider
          ...
          hasNextAvailablePage={hasNextAvailablePage}
          isFetchingMoreAvailableCourses={isFetchingNextAvailablePage}
          fetchNextAvailablePage={fetchNextAvailablePage}
          hasNextHistoryPage={hasNextHistoryPage}
          isFetchingMoreHistory={isFetchingNextHistoryPage}
